            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('gestionReparations')); ?>" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-5">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="<?php echo e(route('export_user_pdf')); ?>" class="btn btn-danger">Import PDF</a>
                                </div>
                                <div class="col">
                                    <div class="dropdown">
            ...
            <div class="container mt-5">
                <div class="search-container mb-3">
                    ...
                    <a href="<?php echo e(route('createUser')); ?>" class="btn btn-info">+ Create a User </a>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5>Facture N° <?php echo e($invoice->id); ?></h5>
                                    <p>Date de création: <?php echo e($invoice->created_at); ?></p>
                                    <p>Réparation associée: <?php echo e($invoice->reparation->id); ?></p>
                                    <p>Client: <?php echo e($invoice->client->name); ?></p>

                                    <h6>Détails de la Réparation:</h6>
                                    <ul>
                                        <li>Statut: <?php echo e($invoice->reparation->status); ?></li>
                                        <!-- Ajoutez d'autres détails de la réparation ici -->
                                    </ul>

                                    <h6>Pièces de Rechange:</h6>
                                    <ul>
                                        <?php $__currentLoopData = $invoice->spareParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sparePart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><?php echo e($sparePart->name); ?> - <?php echo e($sparePart->price); ?></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>

                                    <h6>Services Supplémentaires:</h6>
                                    <ul>
                                        <?php $__currentLoopData = $invoice->additionalServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><?php echo e($service->name); ?> - <?php echo e($service->price); ?></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>

                                    <p>Total: <?php echo e($invoice->total_amount); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\bouji\OneDrive\سطح المكتب\Garagiste\resources\views/gestionInvoice.blade.php ENDPATH**/ ?>