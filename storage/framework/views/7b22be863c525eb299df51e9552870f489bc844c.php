...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="dist/img/soliman.png" alt="AdminLTELogo" height="60"
                width="60">
        </div>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('gestionInvoice')); ?>" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Facturation
                                </p>
                                        ...
                                        <div class="row w-75 mx-auto">
                                            <div class="col-sm d-flex align-items-center">
                                                <button class="btn btn-sm btn-primary btn-block mb-2"
                                                    onclick="showUserDetails(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>', '<?php echo e($user->email); ?>')">
                                                    Show
                                                </button>
                                            </div>
                                            <div class="col-sm d-flex align-items-center">
                                                <a href="<?php echo e(route('updateUser')); ?>"
...
<?php /**PATH C:\Users\bouji\OneDrive\سطح المكتب\Garagiste\resources\views/dashboard.blade.php ENDPATH**/ ?>